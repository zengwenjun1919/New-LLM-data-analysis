...
def train(env_name,train_steps = 200000,suffix="",Ktrain_samples=20000):   
...
if __name__ == "__main__":
    ...
    env_names = ["DampingPendulum", "MountainCarContinuous-v0", "Pendulum-v1"]#["DampingPendulum",
    for i in env_names:
        parser = argparse.ArgumentParser()
        parser.add_argument("--env",type=str,default=i)
        parser.add_argument("--suffix",type=str,default="mamba_test_50_5k_2w_3")#Ksteps,Ktest_data,Ktrain_data
